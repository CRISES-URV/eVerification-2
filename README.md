...
1. Shares generation process (shares are generated by any SC, then this SC is called generator SC).
...
2. Share Distribution between generator SC and receiver SC (this step must be repeated in each receiver SC).
...
4. Homomorphic Decryption (tally)
